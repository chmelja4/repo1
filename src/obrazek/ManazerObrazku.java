...
public class ManazerObrazku {
	...
	private void pripravObrazekKNacteni(Obrazek o) {
		zo.setZdroj(o.getKlic());
		mapaObr.put(o.getKlic(), nactiObrazek(o));
	}
	
	public void pripravObrazky() {
	 pripravObrazekKNacteni(Obrazek.ZED);
	 pripravObrazekKNacteni(Obrazek.POZADI);
	 pripravObrazekKNacteni(Obrazek.HRAC);
	}
